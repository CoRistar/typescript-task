...
var TrafficLightRobot = /** @class */ (function () {
    ...
    TrafficLightRobot.prototype.getNextLight = function () {
    ...
    TrafficLightRobot.prototype.updateDisplay = function () {
        this.lightElement.style.backgroundColor = this.currentLight.toLowerCase();
        this.colorElement.textContent = "Current Color: ".concat(this.currentLight);
        this.timerElement.textContent = "Next change in: ".concat(this.countDown, " seconds");
    };
    TrafficLightRobot.prototype.run = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(this.countDown > 0)) return [3 /*break*/, 4];
                        this.updateDisplay();
